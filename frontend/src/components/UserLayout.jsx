...
import { IconChevronLeft, IconChevronRight, IconClose, IconDoc, IconHome, IconLogout, IconMenu } from './icons.jsx';

const links = [
  { to: '/dashboard', label: 'Dashboard', icon: IconHome },
  { to: '/reports', label: 'Laporan Magang', icon: IconDoc },
];
  ...
  return (
    <div className="min-h-screen md:flex">
        ...
        <div className="w-72 md:w-64 h-full flex flex-col">
          <div className="px-6 py-6 border-b border-white/10 flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-paper/50 mt-0.5">Portal Mahasiswa Magang</p>
            </div>
      ...
      <main className="flex-1 min-w-0">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 md:px-10 py-6 md:py-8">{children}</div>
      </main>
    </div>
  );
}
